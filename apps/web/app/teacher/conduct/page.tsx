...
import { getTeacherClasses, getConductRatings, type ConductRating } from '@/lib/mock-data'
import { DualRatingBadge, getRatingFromScore } from '@/components/teacher/DualRatingBadge'
...
export default function ConductPage() {
  const [ratings, setRatings] = useState<ConductRating[]>([])
  ...
  useEffect(() => {
    async function loadData() {
      ...
      if (homeroomClass) {
        const data = await getConductRatings(homeroomClass.id, filters.semester)
        setRatings(data)
      }
      setLoading(false)
    }
