                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-sm font-semibold text-slate-700">{cls.studentCount} học sinh</span>
                    </div>
                  </div>
                  <button className="mt-4 w-full rounded-lg border border-slate-200 py-2 text-xs font-bold text-slate-600 transition-all hover:bg-slate-50 group-hover:border-[#0284C7] group-hover:text-[#0284C7]">
                    Xem chi tiết
                  </button>
                </div>
              ))}
