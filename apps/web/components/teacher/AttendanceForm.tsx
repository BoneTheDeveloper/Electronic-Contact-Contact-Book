...
export function AttendanceForm({ students, date = new Date(), classId }: AttendanceFormProps) {
  ...
  const summary = {
    P: Object.values(attendance).filter((s: AttendanceStatus) => s === 'P').length,
    A: Object.values(attendance).filter((s: AttendanceStatus) => s === 'A').length,
    L: Object.values(attendance).filter((s: AttendanceStatus) => s === 'L').length,
    E: Object.values(attendance).filter((s: AttendanceStatus) => s === 'E').length,
  }
